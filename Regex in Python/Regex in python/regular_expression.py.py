...
pattern="[a-z]+@+[a-z]+[.com]+"
match=re.findall(pattern,mydata)
for item in match:
    print(item)
...
pattern="[a-z]+@+[a-z]+[.com]+"
res=re.finditer(pattern,mydata)
for i in res:
    print(i)

print(mydata[3845:3873])
...
data="python is a good 7745 programming language 447788"

patt="python\sis\sa\sgood\s\d{4}"
...
for i in enumerate (patt):
    print(list(i))


patt="Washington"
match=re.search(patt,mydata)
print(match)
...
# the regex sub() method in python it is used to sub of any characters and numbers !


data="python is a interpreter language "
patt="\s+"
result=re.sub(patt,"",data)
print(result)


NUM="445566787 445588 6699"
patt="\s+"
match=re.sub(patt,"",NUM)
print(match)
